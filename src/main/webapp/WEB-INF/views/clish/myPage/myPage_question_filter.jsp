						...
						<tr>
							...
							<c:if test="${not empty classQPageInfo.maxPage or classQPageInfo.maxPage > 0}">
								<input type="button" value="이전" 
									onclick="location.href='/myPage/myQuestion/question_inquery?filterType=0&classQuestionPageNum=${classQPageInfo.pageNum - 1 }&classQOrderBy=${classQOrderBy }&classQOrderDir=${classQOrderDir }'" 
								...
								<c:forEach var="i" begin="${classQPageInfo.startPage}" end="${classQPageInfo.endPage}">
									<c:choose>
										...
										<c:otherwise>
											<a href="/myPage/myQuestion/question_inquery?filterType=0&classQuestionPageNum=${i}&classQOrderBy=${classQOrderBy }&classQOrderDir=${classQOrderDir }">${i}</a>
										</c:otherwise>
									</c:choose>
								</c:forEach>
				  	...
				  	<tbody>
						...
						<tr>
							...
							<c:if test="${not empty inqueryPageInfo.maxPage or inqueryPageInfo.maxPage > 0}">
								<input type="button" value="이전" 
									onclick="location.href='/myPage/myQuestion/question_inquery?filterType=1&inqueryPageNum=${inqueryPageInfo.pageNum - 1}&inqueryOrderBy=${inqueryOrderBy }&inqueryOrderDir=${inqueryOrderDir }'" 
								...
								<c:forEach var="i" begin="${inqueryPageInfo.startPage}" end="${inqueryPageInfo.endPage}">
									<c:choose>
										...
										<c:otherwise>
											<a href="/myPage/myQuestion/question_inquery?filterType=1&inqueryPageNum=${i}&inqueryOrderBy=${inqueryOrderBy }&inqueryOrderDir=${inqueryOrderDir }">${i}</a>
										</c:otherwise>
									</c:choose>
								</c:forEach>
